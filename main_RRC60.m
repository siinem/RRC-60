...
% Pattern Recognition Letters 131 (2020): 158-165.
...
param.num_trials = 5;  % Experiments are repeated for 5 random selection of train/val/test sets, mean and std of all are presented.
